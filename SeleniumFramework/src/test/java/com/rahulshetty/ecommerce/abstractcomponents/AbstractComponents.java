...
public class AbstractComponents {
	 ...
	 * "//src//test//java//com//rahulshetty//ecommerce//resources//GlobalVariables")
	 * ; Properties properties=new Properties(); properties.load(fis); String
	 * browser=properties.getProperty("browser");
	 * if(browser.equalsIgnoreCase("chrome")) {
	 * WebDriverManager.chromedriver().setup(); } else
	 * if(browser.equalsIgnoreCase("Firefox")){ //firefox setup } else
	 * if(browser.equalsIgnoreCase("Edge")){ //Edge setup } driver=new
	 * ChromeDriver();
